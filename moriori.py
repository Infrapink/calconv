...
# Convert between Julian Days and the traditional Moriori calendar
...
from months import MORIORI as MONTHS, NUM_MORIORI as MONTHNO

lon = -176 - Fraction(29,60) # longitude of Rēkohu
lat = 0 - 43 - Fraction(54,60) # latitude of Rēkohu
tz = Fraction(12,24) + Fraction(45,1440) # Rēkohu's timezone
...
def tojd(day, month, year):
    '''Convert a date in the Moriori calendar to a Julian Day'''
