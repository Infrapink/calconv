...
def cons_day_julian_todate():
	...
	# Convert a Julian day to a date in the traditional Indian lunicalendar (Kali Yuga)
       ...
       # Convert a Julian day to a date in the Naïve Siddhantic lunisolar calendar (Kali Yuga)
        ...
        nsidd_lunar_ky_day_ent.delete(0, END)
        nsidd_lunar_ky_month_ent.delete(0, END)
        nsidd_lunar_ky_year_ent.delete(0, END)
        nsidd_lunar_ky_day_ent.insert(0, nsidd_lunar_ky_date[0])
        nsidd_lunar_ky_month_ent.insert(0, nsidd_lunar_ky_date[1])
        nsidd_lunar_ky_year_ent.insert(0, nsidd_lunar_ky_date[2])

        # Convert a Julian day to a date in the Naïve Siddhantic lunisolar calendar (Śaka Era)
        nsidd_lunar_se_date = nsidd_lunar_se.fromjd(day)
        nsidd_lunar_se_day_ent.delete(0, END)
        nsidd_lunar_se_month_ent.delete(0, END)
        nsidd_lunar_se_year_ent.delete(0, END)
        nsidd_lunar_se_day_ent.insert(0, nsidd_lunar_se_date[0])
        nsidd_lunar_se_month_ent.insert(0, nsidd_lunar_se_date[1])
        nsidd_lunar_se_year_ent.insert(0, nsidd_lunar_se_date[2])

        # Convert a Julian day to a date in the Naïve Siddhantic lunisolar calendar (Vikram Samvat)
        nsidd_lunar_vs_date = nsidd_lunar_vs.fromjd(day)
        nsidd_lunar_vs_day_ent.delete(0, END)
        nsidd_lunar_vs_month_ent.delete(0, END)
        nsidd_lunar_vs_year_ent.delete(0, END)
        nsidd_lunar_vs_day_ent.insert(0, nsidd_lunar_vs_date[0])
        nsidd_lunar_vs_month_ent.insert(0, nsidd_lunar_vs_date[1])
        nsidd_lunar_vs_year_ent.insert(0, nsidd_lunar_vs_date[2])

        # Convert a Julian day to a date in the Spaśta Siddhantic lunisolar calendar (Kali Yuga)
        siddhantic_lunar_ky_date = siddhantic_lunar_ky.fromjd(day)
        siddhantic_lunar_ky_day_ent.delete(0, END)
        siddhantic_lunar_ky_month_ent.delete(0, END)
        siddhantic_lunar_ky_year_ent.delete(0, END)
        siddhantic_lunar_ky_day_ent.insert(0, siddhantic_lunar_ky_date[0])
        siddhantic_lunar_ky_month_ent.insert(0, siddhantic_lunar_ky_date[1])
        siddhantic_lunar_ky_year_ent.insert(0, siddhantic_lunar_ky_date[2])

        # Convert a Julian day to a date in the Spaśta Siddhantic lunisolar calendar (Śaka Era)
        siddhantic_lunar_se_date = siddhantic_lunar_se.fromjd(day)
        siddhantic_lunar_se_day_ent.delete(0, END)
        siddhantic_lunar_se_month_ent.delete(0, END)
        siddhantic_lunar_se_year_ent.delete(0, END)
        siddhantic_lunar_se_day_ent.insert(0, siddhantic_lunar_se_date[0])
        siddhantic_lunar_se_month_ent.insert(0, siddhantic_lunar_se_date[1])
        siddhantic_lunar_se_year_ent.insert(0, siddhantic_lunar_se_date[2])

        # Convert a Julian day to a date in the Spaśta Siddhantic lunisolar calendar (Vikram Samvat)
        siddhantic_lunar_vs_date = siddhantic_lunar_vs.fromjd(day)
        siddhantic_lunar_vs_day_ent.delete(0, END)
        siddhantic_lunar_vs_month_ent.delete(0, END)
        siddhantic_lunar_vs_year_ent.delete(0, END)
...
def nsidd_lunar_ky_converter():
        day = int(nsidd_lunar_ky_day_ent.get())
        month = nsidd_lunar_ky_month_ent.get()
        year = int(nsidd_lunar_ky_year_ent.get())
        jday = nsidd_lunar_ky.tojd(day, month, year)
        cons_day_julian_ent.delete(0, END)
        cons_day_julian_ent.insert(0, jday)
        cons_day_julian_todate()

def nsidd_lunar_se_converter():
        day = int(nsidd_lunar_se_day_ent.get())
        month = nsidd_lunar_se_month_ent.get()
        year = int(nsidd_lunar_se_year_ent.get())
        jday = nsidd_lunar_se.tojd(day, month, year)
        cons_day_julian_ent.delete(0, END)
        cons_day_julian_ent.insert(0, jday)
        cons_day_julian_todate()

def nsidd_lunar_vs_converter():
        day = int(nsidd_lunar_vs_day_ent.get())
        month = nsidd_lunar_vs_month_ent.get()
        year = int(nsidd_lunar_vs_year_ent.get())
        jday = nsidd_lunar_vs.tojd(day, month, year)
        cons_day_julian_ent.delete(0, END)
        cons_day_julian_ent.insert(0, jday)
        cons_day_julian_todate()

def siddhantic_lunar_ky_converter():
        day = int(siddhantic_lunar_ky_day_ent.get())
        month = siddhantic_lunar_ky_month_ent.get()
        year = int(siddhantic_lunar_ky_year_ent.get())
        jday = siddhantic_lunar_ky.tojd(day, month, year)
        cons_day_julian_ent.delete(0, END)
        cons_day_julian_ent.insert(0, jday)
        cons_day_julian_todate()

def siddhantic_lunar_se_converter():
        day = int(siddhantic_lunar_se_day_ent.get())
        month = siddhantic_lunar_se_month_ent.get()
        year = int(siddhantic_lunar_se_year_ent.get())
        jday = siddhantic_lunar_se.tojd(day, month, year)
        cons_day_julian_ent.delete(0, END)
        cons_day_julian_ent.insert(0, jday)
        cons_day_julian_todate()

def siddhantic_lunar_vs_converter():
        day = int(siddhantic_lunar_vs_day_ent.get())
...
nsidd_lunar_ky_day_lbl = Label(frame, text = "Day").grid(row = 144, column = 0, sticky = W)
nsidd_lunar_ky_day_ent = Entry(frame)
nsidd_lunar_ky_day_ent.grid(row = 145, column = 0, sticky = W)
nsidd_lunar_ky_month_lbl = Label(frame, text = "Month").grid(row = 144, column = 1, sticky = W)
nsidd_lunar_ky_month_ent = Entry(frame)
nsidd_lunar_ky_month_ent.grid(row = 145, column = 1, sticky = W)
nsidd_lunar_ky_year_lbl = Label(frame, text = "Year").grid(row = 144, column = 2, sticky = W)
nsidd_lunar_ky_year_ent = Entry(frame)
nsidd_lunar_ky_year_ent.grid(row = 145, column = 2, sticky = W)
nsidd_lunar_ky_bttn = Button(frame, text = "Calculate", command = nsidd_lunar_ky_converter).grid(row = 146, column = 0, columnspan = 3, sticky = W)

# Naïve Siddhantic lunisolar calendar (Śaka Era)                                                                                            
nsidd_lunar_se_lbl = Label(frame, text = "Naïve Siddhantic lunisolar calendar (Śaka Era)").grid(row = 143, column = 3, columnspan = 3, sticky = W)
nsidd_lunar_se_day_lbl = Label(frame, text = "Day").grid(row = 144, column = 3, sticky = W)
nsidd_lunar_se_day_ent = Entry(frame)
nsidd_lunar_se_day_ent.grid(row = 145, column = 3, sticky = W)
nsidd_lunar_se_month_lbl = Label(frame, text = "Month").grid(row = 144, column = 4, sticky = W)
nsidd_lunar_se_month_ent = Entry(frame)
nsidd_lunar_se_month_ent.grid(row = 145, column = 4, sticky = W)
nsidd_lunar_se_year_lbl = Label(frame, text = "Year").grid(row = 144, column = 5, sticky = W)
nsidd_lunar_se_year_ent = Entry(frame)
nsidd_lunar_se_year_ent.grid(row = 145, column = 5, sticky = W)
nsidd_lunar_se_bttn = Button(frame, text = "Calculate", command = nsidd_lunar_se_converter).grid(row = 146, column = 3, columnspan = 3, sticky = W)

# Naïve Siddhantic lunisolar calendar (Vikram Samvat)                                                                                            
nsidd_lunar_vs_lbl = Label(frame, text = "Naïve Siddhantic lunisolar calendar (Vikram Samvat)").grid(row = 143, column = 6, columnspan = 3, sticky = W)
nsidd_lunar_vs_day_lbl = Label(frame, text = "Day").grid(row = 144, column = 6, sticky = W)
nsidd_lunar_vs_day_ent = Entry(frame)
nsidd_lunar_vs_day_ent.grid(row = 145, column = 6, sticky = W)
nsidd_lunar_vs_month_lbl = Label(frame, text = "Month").grid(row = 144, column = 7, sticky = W)
nsidd_lunar_vs_month_ent = Entry(frame)
nsidd_lunar_vs_month_ent.grid(row = 145, column = 7, sticky = W)
nsidd_lunar_vs_year_lbl = Label(frame, text = "Year").grid(row = 144, column = 8, sticky = W)
nsidd_lunar_vs_year_ent = Entry(frame)
nsidd_lunar_vs_year_ent.grid(row = 145, column = 8, sticky = W)
nsidd_lunar_vs_bttn = Button(frame, text = "Calculate", command = nsidd_lunar_vs_converter).grid(row = 146, column = 6, columnspan = 3, sticky = W)

# Spaśta Siddhantic lunisolar calendar (Kali Yuga)                                                                                            
siddhantic_lunar_ky_lbl = Label(frame, text = "Spaśta Siddhantic lunisolar calendar (Kali Yuga)").grid(row = 148, column = 0, columnspan = 3, sticky = W)
siddhantic_lunar_ky_day_lbl = Label(frame, text = "Day").grid(row = 149, column = 0, sticky = W)
siddhantic_lunar_ky_day_ent = Entry(frame)
siddhantic_lunar_ky_day_ent.grid(row = 150, column = 0, sticky = W)
siddhantic_lunar_ky_month_lbl = Label(frame, text = "Month").grid(row = 149, column = 1, sticky = W)
siddhantic_lunar_ky_month_ent = Entry(frame)
siddhantic_lunar_ky_month_ent.grid(row = 150, column = 1, sticky = W)
siddhantic_lunar_ky_year_lbl = Label(frame, text = "Year").grid(row = 149, column = 2, sticky = W)
siddhantic_lunar_ky_year_ent = Entry(frame)
siddhantic_lunar_ky_year_ent.grid(row = 150, column = 2, sticky = W)
siddhantic_lunar_ky_bttn = Button(frame, text = "Calculate", command = siddhantic_lunar_ky_converter).grid(row = 151, column = 0, columnspan = 3, sticky = W)

# Spaśta Siddhantic lunisolar calendar (Śaka Era)                                                                                            
siddhantic_lunar_se_lbl = Label(frame, text = "Spaśta Siddhantic lunisolar calendar (Śaka Era)").grid(row = 148, column = 3, columnspan = 3, sticky = W)
siddhantic_lunar_se_day_lbl = Label(frame, text = "Day").grid(row = 149, column = 3, sticky = W)
siddhantic_lunar_se_day_ent = Entry(frame)
siddhantic_lunar_se_day_ent.grid(row = 150, column = 3, sticky = W)
siddhantic_lunar_se_month_lbl = Label(frame, text = "Month").grid(row = 149, column = 4, sticky = W)
siddhantic_lunar_se_month_ent = Entry(frame)
siddhantic_lunar_se_month_ent.grid(row = 150, column = 4, sticky = W)
siddhantic_lunar_se_year_lbl = Label(frame, text = "Year").grid(row = 149, column = 5, sticky = W)
siddhantic_lunar_se_year_ent = Entry(frame)
siddhantic_lunar_se_year_ent.grid(row = 150, column = 5, sticky = W)
siddhantic_lunar_se_bttn = Button(frame, text = "Calculate", command = siddhantic_lunar_se_converter).grid(row = 151, column = 3, columnspan = 3, sticky = W)

# Spaśta Siddhantic lunisolar calendar (Vikram Samvat)                                                                                            
siddhantic_lunar_vs_lbl = Label(frame, text = "Spaśta Siddhantic lunisolar calendar (Vikram Samvat)").grid(row = 148, column = 6, columnspan = 3, sticky = W)
siddhantic_lunar_vs_day_lbl = Label(frame, text = "Day").grid(row = 149, column = 6, sticky = W)
siddhantic_lunar_vs_day_ent = Entry(frame)
siddhantic_lunar_vs_day_ent.grid(row = 150, column = 6, sticky = W)
siddhantic_lunar_vs_month_lbl = Label(frame, text = "Month").grid(row = 149, column = 7, sticky = W)
siddhantic_lunar_vs_month_ent = Entry(frame)
siddhantic_lunar_vs_month_ent.grid(row = 150, column = 7, sticky = W)
siddhantic_lunar_vs_year_lbl = Label(frame, text = "Year").grid(row = 149, column = 8, sticky = W)
siddhantic_lunar_vs_year_ent = Entry(frame)
