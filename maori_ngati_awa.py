...
# Convert between Julian Days and the calendar of the Ngāti Awa Māori
...
from months import NGATIAWA as MONTHS, NUM_NGATIAWA as MONTHNO

lon = -177 # longitude of the Bay of Plenty
lat = 0 - 38 # latitude of  the Bay of Plenty
...
def tojd(day, month, year):
    '''Convert a date in the Ngāti Awa calendar to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day to a date in the Ngāti Awa calendar'''
    jday = int(jday)
