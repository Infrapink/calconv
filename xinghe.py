...
# Convert between the Xinghe calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(4117,16860) # tropical year
yue = 29 + Fraction(110647,208530) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1918281 + Fraction(2549,5620)
lunar_epoch = solar_epoch - Fraction(43106119, 1860220)
...
def tojd(day, month, year):
    '''Convert a date in the Xinghe li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Xinghe li'''
    jday = int(jday)
