...
# Convert between Boeotian dates and Julian Days
...
lon = 0 - 23 - Fraction(19,60) - Fraction(4,3600) # longitude of Thebes
lat = 38 + Fraction(19,60) + Fraction(15,3600) # latitude of Thebes
...
def fromjd(jday):
    '''Convert a Julian Day into an Boeotian date'''
    jday = int(jday)
...
def tojd(day, month, year):
    '''Convert an Boeotian date to a Julian Day'''
