...
# Convert between the Wuyin calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(2315, 9464) # tropical year
yue = 29 + Fraction(6901, 13006) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1947135 + Fraction(941, 2366)
lunar_epoch = solar_epoch - Fraction(16899300, 1099007)
...
def tojd(day, month, year):
    '''Convert a date in the Wuyin li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Wuyin li'''
    jday = int(jday)
