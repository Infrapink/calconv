...
# Convert between the Jingchu calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(455, 1843) # tropical year
yue = 29 + Fraction(2419, 4559) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1807247 + Fraction(706, 1843)
lunar_epoch = solar_epoch - Fraction(2288710, 86621)
...
def tojd(day, month, year):
    '''Convert a date in the Jingchu li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Jingchu li'''
    jday = int(jday)
