...
# A programme to convert between Julian Days and the Sherab Ling reform of the Tibetan calendar
...
def tojd(tithi, month, year):
    '''Convert a date in the Sherab Ling calendar to a Julian Day.'''
...
def fromjd(jday):
    '''Given a Julian Day, compute a date in the Sherab Ling calendar'''
    jday = Fraction(jday)
