...
# Convert between the Indian Zoroastrian fixed calendar and Julian Day using the Zoroastrian Religious Era era

from months import NUM_ZOROASTRIAN as NUMONTHS
from months import ZOROASTRIAN_NUM as MONTHNO

epoch = 1086678 #1086742
...
def tojd(day, month, year):
    '''Convert a date in the Qadimi calendar into a Julian Day'''
    day = int(day)
    month = str(month)
    year = int(year)
