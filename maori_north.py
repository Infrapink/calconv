...
# Convert between Julian Days and the calendar of the Māori of Te Tai Tokenau
...
lon = -(177 + Fraction(19,60) + Fraction(25, (60 * 60))) # longitude of Whangārei
lat = 0 - 35 - Fraction(43,60) - Fraction(30, (60 * 60)) # latitude of Whangārei
...
def tojd(day, month, year):
    '''Convert a date in the Te Tai Tokenau calendar to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day to a date in the Te Tai Tokenau calendar'''
    jday = int(jday)
