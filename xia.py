...
# Convert between the Xia calendar (Sifen li) and Julian Days
...
# Epochs.
# I took the actual southern solstice and preceding new moon of the year 423 BC based on Chinese Wikipedia,
