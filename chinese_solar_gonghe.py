...
# Convert between the old Chinese calendar (Gonghe era) and Julian Day.
...
solstice = Fraction(122190899257, 86400) + Fraction(8,24) # Southern solstice of 1 Anno Gonghe = 23 December 2699 BC = 30 Azar 3320 BH, with correction for Chinese Standard Time
