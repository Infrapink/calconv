...
# Convert between John Dee's 33-year calendar and Julian Days

from months import CAESAR as MONTHS, CAESAR_LENGTHS as MONTH_LENGTHS

epoch = 1721425 - 365 # 1 January of the year 0
...
def fromjd(jday):
    '''Convert a Julian Day into a date in Dee's calendar'''
    jday = int(jday)
...
def tojd(day, month, year):
    '''Convert a date in Dee's calendar to a Julian Day'''
