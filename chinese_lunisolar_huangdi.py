...
solar_epoch = Fraction(8831870069, 12000) + 1 # instant of the southern solstice preceding the first year of the reign of Emperor Huangdi, GMT. This corresponds to 21 December 2699 BC and 28 Azar 3320 BH
lunar_epoch = Fraction(79484762719, 108000) + 1 # new moon immediately preceding solar_epoch, GMT
