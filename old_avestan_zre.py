...
# Convert between the Old Avestan calendar and Julian Day, based on the Zarathushtrian Religious Era
...
def fromjd(jday):
    ...
    s = 0
    while (s < 17) and (jday - nowruz >= sexan):
        s += 1
        nowruz += sexan
        year += 6

    if (jday - nowruz >= 420) and (s == 17):
        year += 1
        nowruz += 420
