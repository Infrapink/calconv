...
# Convert between the Sanji calendar and Julian Day

from math import floor
from fractions import Fraction

sui = 365 + Fraction(605,2451) # tropical year
yue = 29 + Fraction(3217,6063) # synodic month
...
solar_epoch = 1861302 + Fraction(635,2451)
lunar_epoch = 1861292 + Fraction(5668,6063)
