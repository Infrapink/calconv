...
# Convert between the Zhengguang calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(1477, 6060) # tropical year
yue = 29 + Fraction(39769, 74952) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1912071 + Fraction(657,6060)
lunar_epoch = solar_epoch - Fraction(294379141, 18925380)
...
def tojd(day, month, year):
    '''Convert a date in the Zhengguang li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Zhengguang li'''
    jday = int(jday)
