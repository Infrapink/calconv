...
# Convert between the Daming calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(9589,39491) # tropical year
yue = 29 + Fraction(2090,3939) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1907323 + Fraction(12481,39491)
lunar_epoch = solar_epoch - Fraction(930568, 513383)
...
def tojd(day, month, year):
    '''Convert a date in the Daming li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Daming li'''
    jday = int(jday)
