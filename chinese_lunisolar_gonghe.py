...
solar_epoch = Fraction(203651319539, 144000) + 1 # instant of the southern solstice preceding the first year of the Gonghe regency, GMT
lunar_epoch = Fraction(152736655699, 108000) + 1# new moon immediately preceding solar_epoch, GMT
