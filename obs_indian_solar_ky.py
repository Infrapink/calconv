...
# A programme to convert between Julian Days and dates in the modern Indian sidereal calendar (Kali Yuga)
...
epoch = ky - Fraction(11,48) # ensure epoch is given in IST
