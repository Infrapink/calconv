...
# A programme to convert between Julian Days and dates in the modern Indian sidereal calendar (Vikram Samvat)
...
epoch = ky + (3046 * sid_year) - Fraction(11,48) # ensure epoch is given in IST
