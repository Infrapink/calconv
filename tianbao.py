...
# Convert between the Tianbao calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(5787,23660) # tropical year
yue = 29 + Fraction(155272,292635) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1922298 + Fraction(4623, 4732)
lunar_epoch = solar_epoch - Fraction(1650562217, 65940420)
...
def tojd(day, month, year):
    '''Convert a date in the Tianbao li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Tianbao li'''
    jday = int(jday)
