...
# Convert between the Daxiang calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(3167,12992) # tropical year
yue = 29 + Fraction(28422,53563) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1932525 + Fraction(2195,3248)
lunar_epoch = solar_epoch - Fraction(26889733, 5999056)
...
def tojd(day, month, year):
    '''Convert a date in the Daxiang li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Daxiang li'''
    jday = int(jday)
