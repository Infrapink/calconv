...
# Convert between the Daye calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(10363, 42640) # tropical year
yue = 29 + Fraction(607, 1144) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1943117 + Fraction(473, 10660)
lunar_epoch = solar_epoch - Fraction(1452669, 58630)
...
def tojd(day, month, year):
    '''Convert a date in the Daye li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Daye li'''
    jday = int(jday)
