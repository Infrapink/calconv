...
# Convert between the Yuanjia calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(150, 608) # tropical year
yue = 29 + Fraction(399, 752) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1883586 + Fraction(126,608)
lunar_epoch = 1883562 + Fraction(42,47)
...
def tojd(day, month, year):
    '''Convert a date in the Yuanjia Jiazi Yuan li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Yuanjia Jiazi Yuan li'''
    jday = int(jday)
