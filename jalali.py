...
#
# Convert between the Jalali Calendar and Julian Day
#
    ...
    if year > 0:
        ...
        while y > year:
            if y - year > 33:
                ...
                y -= 1
                if abs(y) % 33 in leap_years_bh:
                    jday -= 366
                else:
                    jday -= 365

        if abs(year) % 33 in leap_years_bh:
            # leap year
            m = months.IRANIAN_LEAP
        else:
            # not a leap year
