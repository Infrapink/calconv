...
# Convert between the Tianhe calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(5731,23460) # tropical year
yue = 29 + Fraction(153991,290160) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1927777 + Fraction(8617, 11730)
lunar_epoch = solar_epoch - Fraction(1173902447, 113452560)
...
def tojd(day, month, year):
    '''Convert a date in the Tianhe li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Tianhe li'''
    jday = int(jday)
