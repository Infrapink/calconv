...
# Convert between Julian Days and Irv Bromberg's Symmetry 454 calendar
...
month_lengths = {364: (28, 35, 28, 28, 35, 28, 28, 35, 28, 28, 35, 28), # normal years
                 371: (28, 35, 28, 28, 35, 28, 28, 35, 28, 28, 35, 35)} # leap years
...
def fromjd(jday):
    '''Convert a Julian Day into a date in Sym454'''
    jday = int(jday)
...
def tojd(day, month, year):
    '''Convert a date in Sym454 into a Julian Day'''
