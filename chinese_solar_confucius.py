...
# Convert between the old Chinese calendar (Confucius era) and Julian Day.
...
solstice = Fraction(131342407507, 86400) + Fraction(8,24) # Southern solstice of 1 Anno Confucius = 23 December 2699 BC = 30 Azar 3320 BH, with correction for Chinese Standard Time
