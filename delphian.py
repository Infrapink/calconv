...
# Convert between Delphian dates and Julian Days

from solun import first_visible_crescent as fvc, trans, dayof_arab, tropical_year as trop_year, syn_month
from months import DELPHIAN as MONTHS, NUM_DELPHIAN as MONTHNO
from fractions import Fraction

lon = 0 - 22 - Fraction(30,60) - Fraction(5,3600) # longitude of Delphi
lat = 38 + Fraction(28,60) + Fraction(56,3600) # latitude of Delphi
...
def fromjd(jday):
    '''Convert a Julian Day into an Delphian date'''
    jday = int(jday)
...
def tojd(day, month, year):
    '''Convert an Delphian date to a Julian Day'''
