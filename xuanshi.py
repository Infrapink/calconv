...
# Convert between the Xuanshi calendar and Julian Day

from math import floor
from fractions import Fraction
from months import OLD_CHINESE as MONTHS, NUM_OLD_CHINESE as MONTHNO

sui = 365 + Fraction(1759,7200) # tropical year
yue = 29 + Fraction(47251,89052) # synodic month
zhongqi = sui / 12 # major solar term

solar_epoch = 1871530 + Fraction(2978,7200)
lunar_epoch = solar_epoch - Fraction(502283969, 26715600)
...
def tojd(day, month, year):
    '''Convert a date in the Xuanshi li to a Julian Day'''
...
def fromjd(jday):
    '''Convert a Julian Day into a date in the Xuanshi li'''
    jday = int(jday)
